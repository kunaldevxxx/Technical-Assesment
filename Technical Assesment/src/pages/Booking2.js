    ...
    <div className="w-full relative bg-white flex flex-col items-center justify-start text-left text-sm text-white font-ibm-plex-sans">
      ...
      <div className="self-stretch bg-black flex flex-col items-center justify-center py-40 px-4 gap-[40px_0px] z-[2] text-48xl font-inter">
        <div className="w-full flex flex-col items-center justify-center gap-[40px_0px] max-w-[1024px]">
          ...
          <div className="self-stretch flex flex-row flex-wrap items-center justify-start py-8 px-0 gap-[40px] text-77xl border-b-[1px] border-solid border-aquamarine">
            ...
            <div className="flex-1 flex flex-col items-center justify-center gap-[16px_0px] min-w-[220px] text-lg">
              ...
              <div className="self-stretch relative text-3xl leading-[130%] text-seagreen">
                Finalize your Table booking with ease.
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="self-stretch flex flex-col items-center justify-center">
          <b className="self-stretch relative tracking-[-0.02em] leading-[118%] text-ellipsis">
            Select Table
          </b>
        </div>
        <div className="self-stretch flex flex-col items-center justify-start gap-[8px_0px] text-ellipsis text-left text-sm">
          <div className="self-stretch rounded-lg flex flex-col items-start justify-center gap-[4px_0px]">
            <b className="self-stretch relative leading-[150%]">Tables</b>
